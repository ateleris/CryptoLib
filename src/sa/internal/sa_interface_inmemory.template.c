...
void sa_populate(void)
{
    ...
    //sa[43].gvcid_blk.vcid  = 6;
    //sa[43].gvcid_blk.mapid = TYPE_TM;
    ...
    //sa[44].arsnw           = 5;
    //sa[44].stmacf_len      = 16;
    //sa[44].abm_len         = ABM_SIZE;
    //sa[44].gvcid_blk.tfvn  = 0;
